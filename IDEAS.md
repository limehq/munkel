...
| Notch-Auto-Ausblend/Einfahr-Sequenz fehlt | bug | **pending re-QA (Plan 07)** | [`docs/plans/07-notch-retract-verify-fix.md`](apps/windows/docs/plans/07-notch-retract-verify-fix.md) | Vor PR-#22-Merge (07-04 11:28) gemeldet → wahrscheinlich stale. Code korrekt verdrahtet. Re-QA-Gate zuerst, Fix nur bei Repro | 2026-07-03 |
| Menüfenster schließt nicht per Klick-außerhalb | bug | **implemented — QA offen** | [`docs/plans/06-menu-window-dismiss.md`](apps/windows/docs/plans/06-menu-window-dismiss.md) | blur→hide + Suppress-Gate + Tray-Race-Guard. 8 Dateien, typecheck+160 tests grün. Branch `menu-dismiss-on-blur`. Manuelle QA + Commit offen | 2026-07-03 |
