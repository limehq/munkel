    ...
    <>
      ...
      <main className="pt-20 pb-28 border-t border-border max-[600px]:pt-14 max-[600px]:pb-20">
        <div className="mx-auto max-w-[1100px] px-8">
          ...
          <div className="max-w-[70ch] mt-10 text-[length:var(--text-base)] leading-relaxed text-pretty [&>*+*]:mt-5 [&>:first-child]:mt-0 [&_h2]:mt-12 [&_h2]:text-[length:var(--text-2xl)] [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:leading-snug [&_h2]:text-balance [&_h3]:mt-8 [&_h3]:text-[length:var(--text-lg)] [&_h3]:font-semibold [&_h3]:tracking-tight [&_h3]:leading-snug [&_ul]:pl-5 [&_ul]:list-disc [&_li]:mt-2 [&_li::marker]:text-muted-foreground [&_a]:underline [&_a]:underline-offset-[3px] [&_a]:decoration-[var(--border)] [&_a]:[transition:text-decoration-color_0.2s_ease] [&_a:hover]:decoration-[var(--foreground)]">
            {children}
          </div>
        </div>
      </main>
