...
- **DONE:** 22 features (core messaging, notch basics, palette, tray, crypto, CI/packaging, auto-update, recipient avatar chips, opt-in autostart — as of 2026-07-10, P2.1 + P2.4).
- **PARTIAL:** 2 features (settings menu completeness — no native About panel, notch copy message).
- **MISSING:** 16 features (CLI installer, image full-res view, clipboard image paste, rebindable hotkey, hover-C copy, unread indicator, ticker, compact avatar animation, history expand/collapse, notch dynamic resize, auto-update toggle, dev echo/screenshot toggles, copy circle code button, message character limit, reply-sent confirmation).
