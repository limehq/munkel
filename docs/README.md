...
| **Circle leave confirmation dialog** | Done | — | Implemented in `platform/windows/circle-leave-confirmation` (Plan 09); confirmation dialog with Cancel/Escape/backdrop dismissal and safer Cancel focus. |
