...
| **Fix notch vertical oversize (WIN-NOTCH-004)** | Fixed (pending human QA) | — | CSS height constraints + single-message wrapper implemented; visual QA on Windows outstanding. See [Plan 12](../../apps/windows/docs/plans/12-notch-oversize-fix.md) and [`docs/bugs/windows-notch-regression-2026-07-06.md`](./bugs/windows-notch-regression-2026-07-06.md). |
| **Fix notch peek loading ring (WIN-NOTCH-005)** | Fixed (pending human QA) | — | Loading/activity ring not visible during peek: sliver repositioned to bottom of widget, peek/retracted exposed heights adjusted. Automated checks green; visual QA on Windows outstanding. See [Plan 13](../../apps/windows/docs/plans/13-notch-loading-ring-fix.md) and [`docs/bugs/windows-notch-regression-2026-07-06.md`](./bugs/windows-notch-regression-2026-07-06.md). |
| **Fix notch hover reopen (WIN-NOTCH-006)** | Fixed (pending human QA) | — | Hover target moved to the visible bottom sliver; z-index clarified defensively. Automated checks green; visual QA on Windows outstanding. See [Plan 14](../../apps/windows/docs/plans/14-notch-hover-reopen-fix.md) and [`docs/bugs/windows-notch-regression-2026-07-06.md`](./bugs/windows-notch-regression-2026-07-06.md). |
| **Fix notch hover stage-2 preview / timer reset (WIN-NOTCH-007)** | Fixed (pending human QA) | — | New `ui` state, stage-2 preview on hover, click-to-open; automated checks green. See [Plan 15](../../apps/windows/docs/plans/15-notch-hover-stage2-fix.md) and [`docs/bugs/windows-notch-regression-2026-07-06.md`](./bugs/windows-notch-regression-2026-07-06.md). |
| **Fix notch recent history not displayed (WIN-NOTCH-008)** | Fixed (pending human QA) | — | History list is now rendered in `full`, `open` and reply-open states. Automated checks green (211 pass / 2 skip / 0 fail). Visual QA on Windows still outstanding, especially for WIN-NOTCH-004 oversize regression. See [Plan 16](../../apps/windows/docs/plans/16-notch-history-display-fix.md) and [`docs/bugs/windows-notch-regression-2026-07-06.md`](./bugs/windows-notch-regression-2026-07-06.md). |
